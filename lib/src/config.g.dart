...
class BouncerConfig {
  ...
  bool operator ==(Object other) =>
      ...
      other is BouncerConfig &&
          ...
          const ListEquality<String>()
              .equals(excludedProcesses, other.excludedProcesses);
  @override
  int get hashCode =>
      ...
      logLevel.hashCode ^
      const ListEquality<String>().hash(excludedProcesses);
  BouncerConfig copyWith({
    ...
    return BouncerConfig(
      ...
      postNotificationPeriodMinutes:
          postNotificationPeriodMinutes ?? this.postNotificationPeriodMinutes,
...
class _BouncerConfigJsonReviver extends ObjectsBase<BouncerConfig> {
  ...
  BouncerConfig convert(Object? value) {
    ...
    return BouncerConfig(
      ...
      excludedProcesses: convertPropertyOrDefault(
          const Arrays<String, Validatable<String>>(
  ...
  Converter<Object?, Object?>? getPropertyConverter(String property) {
    switch (property) {
      ...
      case 'excludedProcesses':
        return const Arrays<String, Validatable<String>>(
            Validatable(Strings(), NonBlankStringValidator()));
      default:
        return null;
    }
